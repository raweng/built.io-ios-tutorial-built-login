...
- (void)viewDidLoad
{
    ...
    UIImage *originalImage = [UIImage imageWithContentsOfFile:[[AppDelegate builtFrameworkBundle] pathForResource:@"form_button" ofType:@"png"]];
...
- (void)logout:(id)sender{
    ...
    [user logoutInBackgroundWithCompletion:^(ResponseType responseType, NSError *error) {
        if (error == nil) {
            ...
            loginViewController.builtApplication = [AppDelegate sharedAppDelegate].builtApplication;
